...
rec_decode_data(<<>>, Data) ->
    lists:reverse(Data);
rec_decode_data(<<Title:16#100/binary,
                  ...
                  AFP_flag:32/little,
                  % In PinkyCrush there are 14 chart directories stored in the .1 file,
                  % so it looks like AFP data is 10 bytes for each possible chart of a song
