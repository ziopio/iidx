// This file is a modified version of the iconv.c file
// from the https://github.com/processone/iconv repository.
...
ERL_NIF_INIT(iidx_iconv, nif_funcs, load, NULL, NULL, NULL)
